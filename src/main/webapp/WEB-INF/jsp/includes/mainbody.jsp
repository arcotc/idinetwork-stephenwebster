...
<c:if test="${not empty page}">
			<div class="post">
				<div class="header">
					...
					<div class="date"><a href="http://twitter.com/share?original_referer=http%3A%2F%2Fstephenwebster.co.uk%2Fsite%2F${page.key}&text=Stephen%20Webster%20ADI%20%7C%20${page.title}" target="_new"><img src="/static/images/twitter-logo.png" border="0"/></a><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fstephenwebster.co.uk%2Fsite%2F${page.key}" target="_new"><img src="/static/images/facebook-logo.png" border="0"/></a></div>
				</div>
				<div class="content">
					${page.body}
				</div>			
...
<c:if test="${not empty article}">
			<div class="post">
				<div class="header">
					...
					<div class="date"><a href="http://twitter.com/share?original_referer=http%3A%2F%2Fstephenwebster.co.uk%2Fsite%2F${article.key}&text=Stephen%20Webster%20ADI%20%7C%20${article.title}" target="_new"><img src="/static/images/twitter-logo.png" border="0"/></a><a href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fstephenwebster.co.uk%2Fsite%2Farticle%2F${article.key}" target="_new"><img src="/static/images/facebook-logo.png" border="0"/></a></div>
				</div>
				<div class="content">
					<p>${article.copy}</p>
				</div>			
